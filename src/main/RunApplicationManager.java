...
public class RunApplicationManager {
  ...
  public static void main(String[] args) {
    ...
    EventData eventData = new EventDataImpl(1, -1, "code", "", "", new int[]{2017, 7, 23, 11, 55, 0});
    EventData eventData1 = new EventDataImpl(1, -1, "write", "sci-fi", "my house", new int[]{2018, 5, 1, 1, 3, 1});
